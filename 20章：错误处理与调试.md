...
- [20. 错误处理与调试](#20-错误处理与调试)
  - [20.1. 浏览器错误报告](#201-浏览器错误报告)
    - [20.1.1. 桌面控制台](#2011-桌面控制台)
    - [20.1.2. 移动控制台](#2012-移动控制台)
  - [20.2. 错误处理](#202-错误处理)
    - [20.2.1. try/catch 语句](#2021-trycatch-语句)
    - [20.2.2. 抛出错误](#2022-抛出错误)
    - [20.2.3. error 事件](#2023-error-事件)
    - [20.2.4. 错误处理策略](#2024-错误处理策略)
    - [20.2.5. 识别错误](#2025-识别错误)
    - [20.2.6. 区分重大与非重大错误](#2026-区分重大与非重大错误)
    - [20.2.7. 把错误记录到服务器中](#2027-把错误记录到服务器中)
  - [20.3. 调试技术](#203-调试技术)
    - [20.3.1. 把消息记录到控制台](#2031-把消息记录到控制台)
    - [20.3.2. 理解控制台运行时](#2032-理解控制台运行时)
    - [20.3.3. 使用 JavaScript 调试器](#2033-使用-javascript-调试器)
    - [20.3.4. 在页面中打印消息](#2034-在页面中打印消息)
    - [20.3.5. 补充控制台方法](#2035-补充控制台方法)
    - [20.3.6. 抛出错误](#2036-抛出错误)
  - [20.4. 旧版 IE 的常见错误](#204-旧版-ie-的常见错误)
    - [20.4.1. 无效字符](#2041-无效字符)
    - [20.4.2. 未找到成员](#2042-未找到成员)
