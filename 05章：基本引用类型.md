...
- [5. 基本引用类型](#5-基本引用类型)
  ...
  - [5.3. 原始值包装类型](#53-原始值包装类型)
    ...
    - [5.3.2. Number](#532-number)
      - [5.3.2.1. toFixed()](#5321-tofixed)
      - [5.3.2.2. toExponential()](#5322-toexponential)
      - [5.3.2.3. toPrecision()](#5323-toprecision)
      - [5.3.2.4. isInteger()](#5324-isinteger)
    - [5.3.3. String](#533-string)
      - [5.3.3.1. JavaScript 字符](#5331-javascript-字符)
      - [5.3.3.2. normalize()](#5332-normalize)
      - [5.3.3.3. 操作方法](#5333-操作方法)
      - [5.3.3.4. 位置方法](#5334-位置方法)
      - [5.3.3.5. 包含方法](#5335-包含方法)
      - [5.3.3.6. trim()](#5336-trim)
      - [5.3.3.7. repeat()](#5337-repeat)
      - [5.3.3.8. padStart() 与 padEnd()](#5338-padstart-与-padend)
      - [5.3.3.9. 迭代与解构](#5339-迭代与解构)
      - [5.3.3.10. 大小写转换](#53310-大小写转换)
      - [5.3.3.11. 模式匹配](#53311-模式匹配)
      - [5.3.3.12. localeCompare()](#53312-localecompare)
      - [5.3.3.13. HTML 方法](#53313-html-方法)
  - [5.4. 单例内置对象](#54-单例内置对象)
    - [5.4.1. Global](#541-global)
      - [5.4.1.1. URL 编码方法](#5411-url-编码方法)
      - [5.4.1.2. eval()](#5412-eval)
      - [5.4.1.3. Global 对象属性](#5413-global-对象属性)
      - [5.4.1.4. window 对象](#5414-window-对象)
    - [5.4.2. Math](#542-math)
      - [5.4.2.1. Math 对象属性](#5421-math-对象属性)
      - [5.4.2.2. min() 与 max()](#5422-min-与-max)
      - [5.4.2.3. 舍入方法](#5423-舍入方法)
      - [5.4.2.4. random()](#5424-random)
      - [5.4.2.5. 其他方法](#5425-其他方法)
