- [1.1. 代理基础](#11-代理基础)
  - [1.1.1. 创建代理](#111-创建代理)
    - [1.1.1.1. 撤销代理](#1111-撤销代理)
    - [1.1.1.2. 多重代理](#1112-多重代理)
  - [1.1.2. 捕获器](#112-捕获器)
    - [1.1.2.1. 捕获器不变式](#1121-捕获器不变式)
  - [1.1.3. 反射](#113-反射)
  - [1.1.4. 优先使用反射 API](#114-优先使用反射-api)
    - [1.1.4.1. 反射 API 与对象 API](#1141-反射-api-与对象-api)
    - [1.1.4.2. 状态标记](#1142-状态标记)
    - [1.1.4.3. 用一等函数替代操作符](#1143-用一等函数替代操作符)
    - [1.1.4.4. 安全地应用函数](#1144-安全地应用函数)
  - [1.1.5. 代理的问题](#115-代理的问题)
    - [1.1.5.1. this](#1151-this)
    - [1.1.5.2. 代理与内部槽位](#1152-代理与内部槽位)
- [1.2. 具体 API](#12-具体-api)
  - [1.2.1. get()](#121-get)
  - [1.2.2. set()](#122-set)
  - [1.2.3. has()](#123-has)
  - [1.2.4. defineProperty()](#124-defineproperty)
  - [1.2.5. getOwnPropertyDescriptor()](#125-getownpropertydescriptor)
  - [1.2.6. deleteProperty()](#126-deleteproperty)
  - [1.2.7. ownKeys()](#127-ownkeys)
  - [1.2.8. getPrototypeOf()](#128-getprototypeof)
  - [1.2.9. setPrototypeOf()](#129-setprototypeof)
  - [1.2.10. isExtensible()](#1210-isextensible)
  - [1.2.11. preventExtensions()](#1211-preventextensions)
  - [1.2.12. apply()](#1212-apply)
  - [1.2.13. construct()](#1213-construct)
- [1.3. 代理模式](#13-代理模式)
  - [1.3.1. 跟踪属性](#131-跟踪属性)
  - [1.3.2. 隐藏属性](#132-隐藏属性)
  - [1.3.3. 属性验证](#133-属性验证)
...
### 1.2.5. getOwnPropertyDescriptor()
