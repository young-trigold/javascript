...
- [13. 错误处理与调试](#13-错误处理与调试)
  - [13.1. 浏览器错误报告](#131-浏览器错误报告)
    ...
    - [13.1.2. 移动控制台](#1312-移动控制台)
  - [13.2. 错误处理](#132-错误处理)
    - [13.2.1. try/catch 语句](#1321-trycatch-语句)
    - [13.2.2. 抛出错误](#1322-抛出错误)
    - [13.2.3. error 事件](#1323-error-事件)
    - [13.2.4. 错误处理策略](#1324-错误处理策略)
    - [13.2.5. 识别错误](#1325-识别错误)
    - [13.2.6. 区分重大与非重大错误](#1326-区分重大与非重大错误)
    - [13.2.7. 把错误记录到服务器中](#1327-把错误记录到服务器中)
  - [13.3. 调试技术](#133-调试技术)
    - [13.3.1. 把消息记录到控制台](#1331-把消息记录到控制台)
    - [13.3.2. 理解控制台运行时](#1332-理解控制台运行时)
    - [13.3.3. 使用 JavaScript 调试器](#1333-使用-javascript-调试器)
    - [13.3.4. 在页面中打印消息](#1334-在页面中打印消息)
    - [13.3.5. 补充控制台方法](#1335-补充控制台方法)
    - [13.3.6. 抛出错误](#1336-抛出错误)
  - [13.4. 旧版 IE 的常见错误](#134-旧版-ie-的常见错误)
    - [13.4.1. 无效字符](#1341-无效字符)
    - [13.4.2. 未找到成员](#1342-未找到成员)
    - [13.4.3. 未知运行时错误](#1343-未知运行时错误)
    - [13.4.4. 语法错误](#1344-语法错误)
    - [13.4.5. 系统找不到指定资源](#1345-系统找不到指定资源)
