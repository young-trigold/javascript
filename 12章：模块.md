...
- [12. 模块](#12-模块)
  - [12.1. 理解模块模式](#121-理解模块模式)
    ...
    - [12.1.4. 入口](#1214-入口)
    - [12.1.5. 异步依赖](#1215-异步依赖)
    - [12.1.6. 动态依赖](#1216-动态依赖)
    - [12.1.7. 静态分析](#1217-静态分析)
    - [12.1.8. 循环依赖](#1218-循环依赖)
  - [12.2. 凑合的模块系统](#122-凑合的模块系统)
  - [12.3. 使用 ES6 之前的模块加载器](#123-使用-es6-之前的模块加载器)
    - [12.3.1. CommonJS](#1231-commonjs)
    - [12.3.2. 异步模块定义](#1232-异步模块定义)
    - [12.3.3. 通用模块定义](#1233-通用模块定义)
  - [12.4. 使用 ES6 模块](#124-使用-es6-模块)
    - [12.4.1. 模块标签及定义](#1241-模块标签及定义)
