...
- [6. 集合引用类型](#6-集合引用类型)
  - [6.1. Object](#61-object)
    ...
    - [6.1.3. Object 静态方法](#613-object-静态方法)
      - [6.1.3.1. freeze() 与 isFrozen()](#6131-freeze-与-isfrozen)
      - [6.1.3.2. preventExtensions() 与 isExtensible()](#6132-preventextensions-与-isextensible)
      - [6.1.3.3. seal() 与 isSealed()](#6133-seal-与-issealed)
  - [6.2. Array](#62-array)
    - [6.2.1. 创建数组](#621-创建数组)
    - [6.2.2. 数组空位](#622-数组空位)
    - [6.2.3. 数组索引](#623-数组索引)
    ...
    - [6.2.5. 搜索与位置方法](#625-搜索与位置方法)
      - [6.2.5.1. 严格相等搜索方法](#6251-严格相等搜索方法)
      - [6.2.5.2. 断言函数](#6252-断言函数)
    - [6.2.6. 排序方法](#626-排序方法)
    - [6.2.7. 栈方法](#627-栈方法)
    - [6.2.8. 队列方法](#628-队列方法)
    - [6.2.9. 操作方法](#629-操作方法)
...
#### 6.1.3.2. preventExtensions() 与 isExtensible()
