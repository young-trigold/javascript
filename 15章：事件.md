...
- [1.2. 事件处理程序](#12-事件处理程序)
  ...
  - [1.2.2. DOM0 事件处理程序](#122-dom0-事件处理程序)
  - [1.2.3. DOM2 事件处理程序](#123-dom2-事件处理程序)
  - [1.2.4. IE 事件处理程序](#124-ie-事件处理程序)
  - [1.2.5. 跨浏览器事件处理程序](#125-跨浏览器事件处理程序)
- [1.3. 事件对象](#13-事件对象)
  - [1.3.1. DOM 事件对象](#131-dom-事件对象)
  - [1.3.2. IE 事件对象](#132-ie-事件对象)
  - [1.3.3. 跨浏览器事件对象](#133-跨浏览器事件对象)
- [1.4. 事件类型](#14-事件类型)
  - [1.4.1. 用户界面事件](#141-用户界面事件)
  - [1.4.2. 焦点事件](#142-焦点事件)
  - [1.4.3. 鼠标和滚轮事件](#143-鼠标和滚轮事件)
  - [1.4.4. 键盘与输入事件](#144-键盘与输入事件)
  - [1.4.5. 合成事件](#145-合成事件)
  - [1.4.6. HTML5 事件](#146-html5-事件)
  - [1.4.7. 设备事件](#147-设备事件)
  - [1.4.8. 触摸及手势事件](#148-触摸及手势事件)
- [1.5. 内存与性能](#15-内存与性能)
  - [1.5.1. 事件委托](#151-事件委托)
  - [1.5.2. 删除事件处理程序](#152-删除事件处理程序)
  - [1.5.3. 防抖和节流](#153-防抖和节流)
- [1.6. 模拟事件](#16-模拟事件)
  - [1.6.1. DOM 事件模拟](#161-dom-事件模拟)
  - [1.6.2. IE 事件模拟](#162-ie-事件模拟)
...
![14-3-DOM事件流](/illustrations/14-3-DOM事件流.png)
...
![14-4-客户端坐标](/illustrations/14-4-客户端坐标.png)
...
![14-9-orientationchange](/illustrations/14-9-orientationchange.png)
...
![14-10-deviceorientation](/illustrations/14-10-deviceorientation.png)
...
![14-11-alpha-beta-gamma](/illustrations/14-11-alpha-beta-gamma.png)
