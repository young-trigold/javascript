...
- [1.2. 文本框编程](#12-文本框编程)
  ...
  - [1.2.2. 输入过滤](#122-输入过滤)
  - [1.2.3. 自动切换](#123-自动切换)
  - [1.2.4. HTML5 约束验证 API](#124-html5-约束验证-api)
- [1.3. 选择框编程](#13-选择框编程)
  - [1.3.1. 选项处理](#131-选项处理)
  - [1.3.2. 添加选项](#132-添加选项)
  - [1.3.3. 移除选项](#133-移除选项)
  - [1.3.4. 移动和重排选项](#134-移动和重排选项)
- [1.4. 表单序列化](#14-表单序列化)
- [1.5. 富文本编辑](#15-富文本编辑)
  - [1.5.1. 使用 contenteditable](#151-使用-contenteditable)
  - [1.5.2. 与富文本交互](#152-与富文本交互)
  - [1.5.3. 富文本选择](#153-富文本选择)
  - [1.5.4. 通过表单提交富文本](#154-通过表单提交富文本)
