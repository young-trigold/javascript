- [1.1. Date](#11-date)
  - [1.1.1. 继承方法](#111-继承方法)
  - [1.1.2. 格式化方法](#112-格式化方法)
  - [1.1.3. 组件方法](#113-组件方法)
  - [1.1.4. Date 静态方法](#114-date-静态方法)
- [1.2. RegExp](#12-regexp)
  - [1.2.1. RegExp 实例属性](#121-regexp-实例属性)
  - [1.2.2. RegExp 实例方法](#122-regexp-实例方法)
  - [1.2.3. RegExp 静态方法](#123-regexp-静态方法)
- [1.3. 原始值包装类型](#13-原始值包装类型)
  - [1.3.1. Boolean](#131-boolean)
  - [1.3.2. Number](#132-number)
    - [1.3.2.1. toFixed()](#1321-tofixed)
    - [1.3.2.2. toExponential()](#1322-toexponential)
    - [1.3.2.3. toPrecision()](#1323-toprecision)
    - [1.3.2.4. isInteger()](#1324-isinteger)
  - [1.3.3. String](#133-string)
    - [1.3.3.1. JavaScript 字符](#1331-javascript-字符)
    - [1.3.3.2. normalize()](#1332-normalize)
    - [1.3.3.3. 操作方法](#1333-操作方法)
    - [1.3.3.4. 位置方法](#1334-位置方法)
    - [1.3.3.5. 包含方法](#1335-包含方法)
    - [1.3.3.6. trim()](#1336-trim)
    - [1.3.3.7. repeat()](#1337-repeat)
    - [1.3.3.8. padStart() 与 padEnd()](#1338-padstart-与-padend)
    - [1.3.3.9. 迭代与解构](#1339-迭代与解构)
    - [1.3.3.10. 大小写转换](#13310-大小写转换)
    - [1.3.3.11. 模式匹配](#13311-模式匹配)
    - [1.3.3.12. localeCompare()](#13312-localecompare)
    - [1.3.3.13. HTML 方法](#13313-html-方法)
- [1.4. 单例内置对象](#14-单例内置对象)
  - [1.4.1. Global](#141-global)
    - [1.4.1.1. URL 编码方法](#1411-url-编码方法)
    - [1.4.1.2. eval()](#1412-eval)
    - [1.4.1.3. Global 对象属性](#1413-global-对象属性)
    - [1.4.1.4. window 对象](#1414-window-对象)
  - [1.4.2. Math](#142-math)
    - [1.4.2.1. Math 对象属性](#1421-math-对象属性)
    - [1.4.2.2. min() 与 max()](#1422-min-与-max)
    - [1.4.2.3. 舍入方法](#1423-舍入方法)
    - [1.4.2.4. random()](#1424-random)
    - [1.4.2.5. 其他方法](#1425-其他方法)
...
#### 1.3.3.1. JavaScript 字符

JavaScript 字符串由 16 位 **码元(code unit)** 组成。对多数字符来说，每 16 位码元对应一个字符。换句话说，字符串的 length 属性表示字符串包含多少 16 位码元：
