...
- [3. 语言基础](#3-语言基础)
  - [3.1. 词法结构](#31-词法结构)
    ...
    - [3.1.2. 可选分号](#312-可选分号)
    - [3.1.3. 关键字与保留字](#313-关键字与保留字)
    - [3.1.4. 标识符](#314-标识符)
    - [3.1.5. 注释](#315-注释)
    - [3.1.6. 严格模式](#316-严格模式)
  - [3.2. 变量](#32-变量)
    - [3.2.1. var](#321-var)
      - [3.2.1.1. 函数作用域](#3211-函数作用域)
      - [3.2.1.2. var 提升](#3212-var-提升)
      - [3.2.1.3. 重复声明](#3213-重复声明)
      - [3.2.1.4. 全局 var 变量](#3214-全局-var-变量)
    - [3.2.2. let](#322-let)
      - [3.2.2.1. 块作用域](#3221-块作用域)
      - [3.2.2.2. 不能重复声明](#3222-不能重复声明)
      - [3.2.2.3. 没有提升效果](#3223-没有提升效果)
      - [3.2.2.4. 暂时性死区](#3224-暂时性死区)
      - [3.2.2.5. 全局 let 变量](#3225-全局-let-变量)
      - [3.2.2.6. 条件声明](#3226-条件声明)
      - [3.2.2.7. for 语句中的 let](#3227-for-语句中的-let)
    - [3.2.3. const](#323-const)
    - [3.2.4. 声明风格与最佳实践](#324-声明风格与最佳实践)
  - [3.3. 数据类型与值](#33-数据类型与值)
    - [3.3.1. typeof 操作符](#331-typeof-操作符)
    - [3.3.2. Undefined 类型](#332-undefined-类型)
    - [3.3.3. Null 类型](#333-null-类型)
    - [3.3.4. Boolean 类型](#334-boolean-类型)
      - [3.3.4.1. 转换为布尔类型](#3341-转换为布尔类型)
    - [3.3.5. Number 类型](#335-number-类型)
      - [3.3.5.1. 浮点数](#3351-浮点数)
      - [3.3.5.2. 舍入误差](#3352-舍入误差)
      - [3.3.5.3. 值的范围](#3353-值的范围)
      - [3.3.5.4. NaN](#3354-nan)
      - [3.3.5.5. 数值转换](#3355-数值转换)
    - [3.3.6. String 类型](#336-string-类型)
      - [3.3.6.1. 字符字面量](#3361-字符字面量)
      - [3.3.6.2. 不可变性](#3362-不可变性)
      - [3.3.6.3. 转换为字符串](#3363-转换为字符串)
      - [3.3.6.4. 模板字面量](#3364-模板字面量)
      - [3.3.6.5. 字符串插值](#3365-字符串插值)
      - [3.3.6.6. 模板字面量标签函数](#3366-模板字面量标签函数)
      - [3.3.6.7. 原始字符串](#3367-原始字符串)
    - [3.3.7. Symbol 类型](#337-symbol-类型)
      - [3.3.7.1. 基本用法](#3371-基本用法)
      - [3.3.7.2. 全局符号注册表](#3372-全局符号注册表)
      - [3.3.7.3. 符号作为属性](#3373-符号作为属性)
      - [3.3.7.4. 常用内置符号](#3374-常用内置符号)
    - [3.3.8. Object 类型](#338-object-类型)
  - [3.4. 表达式与操作符](#34-表达式与操作符)
    - [3.4.1. 一元操作符](#341-一元操作符)
    - [3.4.2. 加性操作符](#342-加性操作符)
    - [3.4.3. 乘性操作符](#343-乘性操作符)
    - [3.4.4. 指数操作符](#344-指数操作符)
    - [3.4.5. 位操作符](#345-位操作符)
    - [3.4.6. 布尔操作符](#346-布尔操作符)
    - [3.4.7. 关系操作符](#347-关系操作符)
    - [3.4.8. 相等操作符](#348-相等操作符)
    - [3.4.9. 赋值操作符](#349-赋值操作符)
    - [3.4.10. 条件操作符](#3410-条件操作符)
    - [3.4.11. 逗号操作符](#3411-逗号操作符)
  - [3.5. 流控制语句](#35-流控制语句)
    - [3.5.1. 分支语句](#351-分支语句)
      - [3.5.1.1. if 语句](#3511-if-语句)
      - [3.5.1.2. switch 语句](#3512-switch-语句)
    - [3.5.2. 循环语句](#352-循环语句)
      - [3.5.2.1. while 语句](#3521-while-语句)
      - [3.5.2.2. do-while 语句](#3522-do-while-语句)
      - [3.5.2.3. for 语句](#3523-for-语句)
      - [3.5.2.4. for-in 语句](#3524-for-in-语句)
    - [3.5.3. 跳转语句](#353-跳转语句)
      - [3.5.3.1. label 语句](#3531-label-语句)
      - [3.5.3.2. break 与 continue 语句](#3532-break-与-continue-语句)
    - [3.5.4. with 语句](#354-with-语句)
  - [3.6. 函数](#36-函数)
...
递增/递减操作符不仅限于操作数值类型的值。它在用于其他类型的值时，会先使用 Number() 转型函数将该值转为数值，再进行递增/递减，需要注意的是，这种转换是不可逆的。
