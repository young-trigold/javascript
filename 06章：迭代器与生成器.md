- [1.1. 迭代器模式](#11-迭代器模式)
  - [1.1.1. 可迭代协议](#111-可迭代协议)
  - [1.1.2. 迭代器协议](#112-迭代器协议)
  - [1.1.3. 自定义可迭代对象](#113-自定义可迭代对象)
  - [1.1.4. 提前终止迭代器](#114-提前终止迭代器)
- [1.2. 生成器](#12-生成器)
  - [1.2.1. 生成器基础](#121-生成器基础)
  - [1.2.2. yield](#122-yield)
  - [1.2.3. 生成器作为迭代器](#123-生成器作为迭代器)
  - [1.2.4. 提前终止迭代器](#124-提前终止迭代器)
...
console.log(arrayIterator[Symbol.iterator]);
// -> [Function: [Symbol.iterator]]
```

这样设计，使用 keys() 和 values() 变得非常便捷。

```javascript
const array = [1, 2, 3];
const valueIterator = array.values();

console.log(...valueIterator);
// -> 1, 2, 3
```

我们把这种迭代器对象称为 **可迭代迭代器(iterable iterator)**。

### 1.1.3. 自定义可迭代对象

下面通过一个具体的例子，来讲解如何自定义可迭代对象。

我们的目标是使得数字变得可迭代。这就要在 Number.prototype 上暴露 Symbol.iterator 属性。实现 iterable 接口。
...
Number.prototype[Symbol.iterator] = function () {
  ...
  return {
    next: () => {
      return { value: i, done: i++ === this.valueOf() };
    },
    [Symbol.iterator]() {
      return this;
    },
