...
- [9. 函数](#9-函数)
  - [9.1. 创建函数](#91-创建函数)
    ...
    - [9.1.2. 函数表达式](#912-函数表达式)
      - [9.1.2.1. 命名函数表达式](#9121-命名函数表达式)
    - [9.1.3. 箭头函数](#913-箭头函数)
    - [9.1.4. Function() 构造函数](#914-function-构造函数)
  - [9.2. 理解函数](#92-理解函数)
    - [9.2.1. 函数的本质](#921-函数的本质)
      - [9.2.1.1. 可调用性](#9211-可调用性)
      - [9.2.1.2. 函数也有属性或方法](#9212-函数也有属性或方法)
      - [9.2.1.3. 函数也是值](#9213-函数也是值)
    - [9.2.2. 立即调用函数表达式](#922-立即调用函数表达式)
  - [9.3. 参数](#93-参数)
      - [9.3.0.1. 箭头函数中的参数](#9301-箭头函数中的参数)
    - [9.3.1. 没有重载](#931-没有重载)
    - [9.3.2. 默认参数值](#932-默认参数值)
      - [9.3.2.1. 默认参数作用域与暂时性死区](#9321-默认参数作用域与暂时性死区)
    - [9.3.3. 参数扩展和收集](#933-参数扩展和收集)
      - [9.3.3.1. 扩展参数](#9331-扩展参数)
      - [9.3.3.2. 收集参数](#9332-收集参数)
  - [9.4. 函数内部](#94-函数内部)
    - [9.4.1. arguments](#941-arguments)
    - [9.4.2. this](#942-this)
      - [9.4.2.1. 全局上下文](#9421-全局上下文)
      - [9.4.2.2. 标准函数上下文](#9422-标准函数上下文)
      - [9.4.2.3. 箭头函数](#9423-箭头函数)
  ...
  - [9.6. 函数方法](#96-函数方法)
    ...
    - [9.6.3. bind()](#963-bind)
      - [9.6.3.1. 箭头函数](#9631-箭头函数)
    - [9.6.4. 其他函数方法](#964-其他函数方法)
  - [9.7. 闭包](#97-闭包)
    - [9.7.1. this 对象](#971-this-对象)
    - [9.7.2. 内存泄漏](#972-内存泄漏)
  - [9.8. 私有变量](#98-私有变量)
    - [9.8.1. 静态私有变量](#981-静态私有变量)
    - [9.8.2. 模块模式](#982-模块模式)
    - [9.8.3. 模块增强模式](#983-模块增强模式)
  - [9.9. 尾调用优化](#99-尾调用优化)
    - [9.9.1. 尾调用优化的条件](#991-尾调用优化的条件)
    - [9.9.2. 尾调用优化的代码](#992-尾调用优化的代码)
