...
- [19. 客户端检测](#19-客户端检测)
  - [19.1. 能力检测](#191-能力检测)
    - [19.1.1. 安全能力检测](#1911-安全能力检测)
    - [19.1.2. 基于能力检测进行浏览器分析](#1912-基于能力检测进行浏览器分析)
  - [19.2. 用户代理检测](#192-用户代理检测)
    - [19.2.1. 用户代理的历史](#1921-用户代理的历史)
    - [19.2.2. 浏览器分析](#1922-浏览器分析)
  - [19.3. 软件和硬件检测](#193-软件和硬件检测)
    - [19.3.1. 识别浏览器和操作系统](#1931-识别浏览器和操作系统)
    - [19.3.2. 浏览器元数据](#1932-浏览器元数据)
    - [19.3.3. 硬件](#1933-硬件)
