...
- [1.1. window](#11-window)
  - [1.1.1. window 与 Gobal](#111-window-与-gobal)
  - [1.1.2. 窗口关系](#112-窗口关系)
  - [1.1.3. 导航与打开新窗口](#113-导航与打开新窗口)
  - [1.1.4. 窗口位置和像素比](#114-窗口位置和像素比)
  - [1.1.5. 窗口大小](#115-窗口大小)
  - [1.1.6. 视口位置](#116-视口位置)
  - [1.1.7. 定时器](#117-定时器)
  - [1.1.8. 系统对话框](#118-系统对话框)
- [1.2. location](#12-location)
  - [1.2.1. 查询字符串](#121-查询字符串)
  - [1.2.2. 操作地址](#122-操作地址)
- [1.3. navigator](#13-navigator)
  - [1.3.1. 检测插件](#131-检测插件)
  - [1.3.2. 注册处理程序](#132-注册处理程序)
- [1.4. screen](#14-screen)
- [1.5. history](#15-history)
  - [1.5.1. 导航](#151-导航)
  - [1.5.2. 历史状态管理](#152-历史状态管理)
