- [1.1. Object](#11-object)
  - [1.1.1. 对象基础](#111-对象基础)
  - [1.1.2. 实例方法](#112-实例方法)
  - [1.1.3. Object 静态方法](#113-object-静态方法)
    - [1.1.3.1. freeze() 与 isFrozen()](#1131-freeze-与-isfrozen)
    - [1.1.3.2. preventExtensions() 与 isExtensible()](#1132-preventextensions-与-isextensible)
    - [1.1.3.3. seal() 与 isSealed()](#1133-seal-与-issealed)
- [1.2. Array](#12-array)
  - [1.2.1. 创建数组](#121-创建数组)
  - [1.2.2. 数组空位](#122-数组空位)
  - [1.2.3. 数组索引](#123-数组索引)
  - [1.2.4. 检测数组](#124-检测数组)
  - [1.2.5. 搜索与位置方法](#125-搜索与位置方法)
    - [1.2.5.1. 严格相等搜索方法](#1251-严格相等搜索方法)
    - [1.2.5.2. 断言函数](#1252-断言函数)
  - [1.2.6. 排序方法](#126-排序方法)
  - [1.2.7. 栈方法](#127-栈方法)
  - [1.2.8. 队列方法](#128-队列方法)
  - [1.2.9. 操作方法](#129-操作方法)
  - [1.2.10. 迭代方法](#1210-迭代方法)
  - [1.2.11. 迭代器方法](#1211-迭代器方法)
  - [1.2.12. 归并方法](#1212-归并方法)
  - [1.2.13. 复制与填充方法](#1213-复制与填充方法)
  - [1.2.14. 转换方法](#1214-转换方法)
- [1.3. 定型数组](#13-定型数组)
  - [1.3.1. 历史](#131-历史)
  - [1.3.2. ArrayBuffer](#132-arraybuffer)
  - [1.3.3. DataView](#133-dataview)
  - [1.3.4. 定型数组](#134-定型数组)
- [1.4. Map](#14-map)
  - [1.4.1. 基本 API](#141-基本-api)
  - [1.4.2. 迭代](#142-迭代)
  - [1.4.3. Object 还是 Map](#143-object-还是-map)
- [1.5. WeakMap](#15-weakmap)
  - [1.5.1. 基本 API](#151-基本-api)
  - [1.5.2. 弱键](#152-弱键)
  - [1.5.3. 不可迭代键](#153-不可迭代键)
  - [1.5.4. 使用弱映射](#154-使用弱映射)
- [1.6. Set](#16-set)
  - [1.6.1. 基本 API](#161-基本-api)
  - [1.6.2. 迭代](#162-迭代)
  - [1.6.3. 扩展集合](#163-扩展集合)
- [1.7. WeakSet](#17-weakset)
  - [1.7.1. 基本 API](#171-基本-api)
  - [1.7.2. 弱值](#172-弱值)
  - [1.7.3. 不可迭代值](#173-不可迭代值)
  - [1.7.4. 使用弱集合](#174-使用弱集合)
- [1.8. 迭代与扩展操作](#18-迭代与扩展操作)
...
#### 1.1.3.2. preventExtensions() 与 isExtensible()
